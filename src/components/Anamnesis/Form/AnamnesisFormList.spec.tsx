...
describe("AnamnesisFormList", () => {
  ...
  it("sorts the forms by description when the description header is clicked", () => {
    ...
    expect(firstRow).toHaveTextContent(
      "General HealthGeneral health questions1/1/2023 ViewEdit Delete"
    );

    fireEvent.click(descriptionHeader);

    const firstRowDesc = screen.getAllByRole("row")[1];
    expect(firstRowDesc).toHaveTextContent(
      "Medical HistoryQuestions about your past medical history2/15/2023 ViewEdit Delete"
    );
  });
